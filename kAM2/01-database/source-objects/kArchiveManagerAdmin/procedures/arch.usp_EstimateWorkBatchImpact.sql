...
-- ============================================================================
-- LEGACY TOMBSTONE (v1.0) -- arch.usp_EstimateWorkBatchImpact
-- ----------------------------------------------------------------------------
...
-- ============================================================================
CREATE OR ALTER PROCEDURE [arch].[usp_EstimateWorkBatchImpact]
(
      @WorkBatchId   bigint
    , @SourceDb      sysname
    , @LookbackRuns  int = 10
...
BEGIN
    SET NOCOUNT ON;
    THROW 50026, 'LEGACY BLOCKED: arch.usp_EstimateWorkBatchImpact is v1.0 only and has been retired. Use arch.usp_Api_EstimateNextRunImpact (v2.0 prepared-batch model).', 1;
END
GO
