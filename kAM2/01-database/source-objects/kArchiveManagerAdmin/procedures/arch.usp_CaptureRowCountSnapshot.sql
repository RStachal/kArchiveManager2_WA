...
-- ============================================================================
-- LEGACY TOMBSTONE (v1.0) -- arch.usp_CaptureRowCountSnapshot
-- ----------------------------------------------------------------------------
...
-- ============================================================================
CREATE OR ALTER PROCEDURE [arch].[usp_CaptureRowCountSnapshot]
    @SourceDb      sysname,
    @ArchiveDb     sysname,
    @SnapshotAtUtc datetime2(0) = NULL,
    @ProcessCode   sysname = NULL
AS
BEGIN
    SET NOCOUNT ON;
    THROW 50029, 'LEGACY BLOCKED: arch.usp_CaptureRowCountSnapshot is v1.0 only and has been retired. Use arch.usp_Api_EstimateNextRunImpact (v2.0 prepared-batch model).', 1;
END
GO
