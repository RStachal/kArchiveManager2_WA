...
-- ============================================================================
-- LEGACY TOMBSTONE (v1.0) -- arch.usp_EstimateLatestWorkBatchImpact
-- ----------------------------------------------------------------------------
...
-- ============================================================================
CREATE OR ALTER PROCEDURE [arch].[usp_EstimateLatestWorkBatchImpact]
(
      @LookbackRuns int = 10
    , @OutputMode   nvarchar(10) = NBOTH
)
AS
BEGIN
    SET NOCOUNT ON;
    THROW 50027, 'LEGACY BLOCKED: arch.usp_EstimateLatestWorkBatchImpact is v1.0 only and has been retired. Use arch.usp_Api_EstimateNextRunImpact (v2.0 prepared-batch model).', 1;
END
GO
