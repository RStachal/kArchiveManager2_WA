...
-- ============================================================================
-- LEGACY TOMBSTONE (v1.0) -- arch.usp_RunWorkBatch
-- ----------------------------------------------------------------------------
...
-- Replacement: arch.usp_RunPreparedBatch
-- See: docs/legacy-consolidation.md  (consolidation decision record)
-- ============================================================================
CREATE OR ALTER PROCEDURE [arch].[usp_RunWorkBatch]
    @WorkBatchId bigint,
...
BEGIN
    SET NOCOUNT ON;
    THROW 50022, 'LEGACY BLOCKED: arch.usp_RunWorkBatch is v1.0 only and has been retired. Use arch.usp_RunPreparedBatch (v2.0 prepared-batch model).', 1;
END
GO
