...
-- ============================================================================
-- LEGACY TOMBSTONE (v1.0) -- arch.usp_RunConfiguredProcesses
-- ----------------------------------------------------------------------------
...
-- Replacement: arch.usp_RunConfiguredProcesses_Prepared
-- See: docs/legacy-consolidation.md  (consolidation decision record)
-- ============================================================================
CREATE OR ALTER PROCEDURE [arch].[usp_RunConfiguredProcesses]
...
BEGIN
    SET NOCOUNT ON;
    THROW 50021, 'LEGACY BLOCKED: arch.usp_RunConfiguredProcesses is v1.0 only and has been retired. Use arch.usp_RunConfiguredProcesses_Prepared (v2.0 prepared-batch model).', 1;
END
GO
